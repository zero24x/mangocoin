...
const string strMessageMagic = "MangoCoin Signed Message:\n";
...
bool CBlock::AcceptBlock()
{
    ...
    if (LAST_POW_BLOCK_DEFINED && IsProofOfWork() && nHeight > LAST_POW_BLOCK)
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "MangoCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "NyTimes.com May 20 2018 - Mueller to End Obstruction Inquiry by Sept. 1, Giuliani Says";
        CTransaction txNew;
        txNew.nTime = 1526856476;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xa923b66bf52c852ff8d36d623f0f2b7528c6237d65f844c488a4219808f4aacc"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xb2, 0xe4, 0xd2, 0x3d };
